...
var dropdownIcon = require('../../assets/icons/dropdown.png')

class SearchOption_Dropdown extends Component {
    constructor(props) {
        super(props)
        this.state = {}
        this.titleStyle = {
            ...
            <View>
                ...
                <TouchableHighlight
                    ...
                    <View style={styles.inline}>
                        <Text numberOfLines={1} style={[{ width: '90%' }, this.valueTextStyle, this.props.valueTextStyle,]}>
                            {this.defaultValue}
                        </Text>
                        <View style={{ width: '10%', paddingRight: 2, alignItems: 'flex-end', justifyContent: 'center' }}>
                            <IconMenu
                                type={'icon'}
                                textPosition={'left'}
...
export default SearchOption_Dropdown